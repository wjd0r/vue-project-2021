<template>
  <b-overlay :show="repositoryLoading || subscribeLoading" class="content-common-component process-component discovery-compoenent" :class="`lang-${$i18n.locale}`" no-fade bg-color="#fff" opacity="1">
    ...
    const clientState: IClientState = {
      ...
      processDiscovery: {
        ...
        filter: {
          ...
          isComparedToPM: this.filter.isComparedToPM,
        },
        variant: {
          id: this.variantId,
