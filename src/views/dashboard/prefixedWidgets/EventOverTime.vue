...
import { EventOverTimeData } from './SampleData';

@Component({})
export default class EventOverTime extends Mixins(WidgetMixin, UtilsMixin) {
  /* Prop 선언 */
  ...
  // 이벤트 추이
  name: string = 'overview.chart.events.over.time';
  ...
  data: IWidgetDataConfiguration = {
    ...
    dataParams: {
      overTimeFormat: 'YYYY-MM-DD HH24',
    },
  };

  sampleData = EventOverTimeData;
