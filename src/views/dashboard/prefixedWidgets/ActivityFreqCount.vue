...
import { ActivityFreqCountData } from './SampleData';

@Component({})
export default class ActivityFreqCount extends Mixins(WidgetMixin, UtilsMixin) {
  /* Prop 선언 */
  ...
  // 액티비티 별 발생 건수
  name: string = 'activity.chart.count';
  ...
  sampleData = ActivityFreqCountData;
  ...
  onColorPaletteChanged(newValue: boolean) {
    this.setColor();
