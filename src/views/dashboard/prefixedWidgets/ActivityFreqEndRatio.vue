...
import { ActivityFreqEndRatioData } from './SampleData';

@Component({})
export default class ActivityFreqEndRatio extends Mixins(WidgetMixin, UtilsMixin) {
  /* Prop 선언 */
  ...
  // 종료 액티비티 비율
  name: string = 'activity.chart.end.ratio';
  ...
  sampleData = ActivityFreqEndRatioData;
