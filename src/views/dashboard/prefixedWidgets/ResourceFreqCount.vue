...
import { ResourceFreqCountData } from './SampleData';

@Component({})
export default class ResourceFreqCount extends Mixins(WidgetMixin, UtilsMixin) {
  /* Prop 선언 */
  ...
  // 리소스 별 발생 건수
  name: string = 'resource.chart.count';
  ...
  sampleData = ResourceFreqCountData;
