...
import { OriginatorMeanDurationData } from './SampleData';

@Component({})
export default class OriginatorMeanDuration extends Mixins(WidgetMixin, UtilsMixin) {
  /* Prop 선언 */
  ...
  // 담당자 별 평균 소요시간
  name: string = 'originator.chart.mean.duration';
  ...
  data: IWidgetDataConfiguration = {
    ...
    dataParams: {
      nLimit: 25, // 담당자가 26 넘어가면 기타로 일괄로 계산됨
    },
  };

  sampleData = OriginatorMeanDurationData;
