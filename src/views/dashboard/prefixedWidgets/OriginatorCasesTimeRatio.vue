...
export default class OriginatorCasesTimeRatio extends Mixins(WidgetMixin, WidgetTableMixin, UtilsMixin) {
  /* Prop 선언 */
  ...
  // 담당자 별 건수 대비 소요시간 비율
  name: string = 'originator.chart.event.to.duration.ratio';
