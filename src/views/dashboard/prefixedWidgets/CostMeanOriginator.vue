...
import { CostMeanOriginatorData } from './SampleData';

@Component({})
export default class CostMeanOriginator extends Mixins(WidgetMixin, UtilsMixin) {
  /* Prop 선언 */
  ...
  name: string = 'cost.chart.avg.by.originator';
  ...
  sampleData = CostMeanOriginatorData;
