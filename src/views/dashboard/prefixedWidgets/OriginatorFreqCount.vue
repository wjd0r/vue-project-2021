...
import { OriginatorFreqCountData } from './SampleData';

@Component({})
export default class OriginatorFreqCount extends Mixins(WidgetMixin, UtilsMixin) {
  /* Prop 선언 */
  ...
  // 담당자 별 발생 건수
  name: string = 'originator.chart.count';
  ...
  sampleData = OriginatorFreqCountData;
